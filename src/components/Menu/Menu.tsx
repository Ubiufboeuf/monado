  ...
  return (
    <>
      <aside
        ref={asideMenuRef}
        id='asideMenu'
        class={`${className} group fixed top-14 -left-60 menu-open:left-0 [transition:left_250ms_ease] z-100 w-60 h-[calc(100dvh-56px)] bg-base-dark`}
      ...
      <label
        ...
        class='fixed left-0 top-0 z-9 w-full h-dvh [transition:all_250ms_ease_allow-discrete] pointer-events-none bg-transparent backdrop-blur-xs opacity-0 menu-open:not-ml:pointer-events-auto menu-open:not-ml:bg-black/40 menu-open:not-ml:opacity-100'
      />
    </>
  )
}
