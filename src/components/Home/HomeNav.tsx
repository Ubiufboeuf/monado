...
export function HomeNav () {
  ...
  return (
    <nav
      id='homeNav'
      class='fixed z-8 right-0 top-14 flex items-end h-10 xs:h-14 min-h-fit w-full sm:w-[calc(100%-72px)] menu-open:ml:w-navbar py-2 px-4 sm:px-6 bg-base-dark transition-all'
    >
