...
export function TabBar () {
  ...
  return (
    <nav class='fixed bottom-0 flex items-center justify-evenly h-18 w-full sm:px-4 border-t overflow-x-auto [scrollbar-width:none] backdrop-blur-2xl bg-base-dark/80 border-neutral-700'>
